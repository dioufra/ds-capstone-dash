...
import pandas as pd
import dash
import dash.dcc as dcc  # Use dash.dcc
import dash.html as html  # Use dash.html
...
# create launch site variable for dropdown
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',
                                    options=[{'label': 'All Sites', 'value': 'ALL'}] + launch_sites_options,
                                    value = 'ALL',
